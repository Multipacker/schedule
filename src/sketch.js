...
const url = "https://cloud.timeedit.net/chalmers/web/public/ri617QQQY83Zn4Q5868548Z5y6Z55.ics";
...
const data = await getCalendar(url);

let events = [];
const ical_events = ical.parseICS(data);
